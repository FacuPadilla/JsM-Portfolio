...
// Import diferido del PinContainer si internamente usa mouse/3D
const PinContainer = dynamic(
  () => import("./ui/3d-pin").then((m) => m.PinContainer),
  {
    ssr: false,
  }
);
            ...
            <PinContainer title="Visit" href={link}>
              ...
              <div className="flex items-center justify-between mt-7 mb-3">
                ...
                <div className="flex justify-center items-center">
                  <p className="flex lg:text-xl md:tet-xs text-sm text-purple">
                    Check live site
                  </p>
                  <FaLocationArrow color="#CBACE9" className="ms-3" />
                </div>
              </div>
            </PinContainer>
          </div>
